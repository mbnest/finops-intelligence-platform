...
- `dq_check_apm_id_present`: tracks the share of resources with a resolved APM ID (target: at or above the current baseline), trended over time as a governance KPI as well as a pass/fail gate.
